...
class App {
    ...
    private initMiddleware(): void {
        ...
        this.express.use('/.well-known/acme-challenge/vBP81_SSQFfTdEFaMO_x849S10gjiaUzlXDZ8c1K4G8', (req, res) => {
            try {
                res.send("vBP81_SSQFfTdEFaMO_x849S10gjiaUzlXDZ8c1K4G8.5AMUXR7QSFE3WjrcuI5CEuc2VeLgpcbqq5G0Q4iVGGg")
            } catch (error) {
    ...
    public listen(): void {
        try {
            if (process.env.NODE_ENV === 'staging') {
                ...
                const certificate = fs.readFileSync('/etc/letsencrypt/live/ecom-api.colorzweb.com/cert.pem', 'utf8');
                const ca = fs.readFileSync('/etc/letsencrypt/live/ecom-api.colorzweb.com/fullchain.pem', 'utf8');
